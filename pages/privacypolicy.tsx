...
const PrivacyPolicy = () => {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <p>
        Welcome to Jannah ("us", "we", or "our") mobile application. We are
      ...
      <p>
        By using the Jannah App, you agree to the practices described in this
        Privacy Policy.
      </p>

      <h3 style={{ fontWeight: 'bold' }}>1. Information We Collect</h3>
      <p>When you register and use the Jannah App, we may collect the following types of personal information:</p>
      <ul>
        <li>
